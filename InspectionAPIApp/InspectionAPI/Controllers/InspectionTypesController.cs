...
namespace InspectionAPI.Controllers
{
    ...
    public class InspectionTypesController : ControllerBase
    {
        ...
        public async Task<ActionResult<InspectionType>> PostInspectionType(InspectionType inspectionType)
        {
            ...
            return CreatedAtAction("GetInspectionType", new { id = inspectionType.InspectionTypeId }, inspectionType);
        }
        ...
        {
            return _context.InspectionTypes.Any(e => e.InspectionTypeId == id);
        }
    }
}
